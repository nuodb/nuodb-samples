...
public class Randoms extends Random {
    private static final long serialVersionUID = -7675628497571395345L;
    ...
    /**
     * Return a random double in the range 0 to 1, inclusive, uniformly sampled from that range. The mean of this distribution is 0.5. The variance is
     * 1/12.
     */
    ...
    /**
     * Return a random double in the range a to b, inclusive, uniformly sampled from that range. The mean of this distribution is (b-a)/2. The
