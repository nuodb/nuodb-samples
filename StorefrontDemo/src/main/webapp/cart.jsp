    ...
    <div id="checkout" class="row">
        ...
        <script id="tpl-cart" type="text/template">    
                        ...
                        <tbody>
                            {{#result}}
                                <tr>
                                    <td>
                                        <div class="media">
                                            <a class="pull-left" href="product.jsp?productId={{product.id}}"><img class="img-rounded pull-left" style="width: 130px; height: 90px;"
                                    ...
                                    <td class="text-right"><input class="input-mini" type="number" id="quantity" name="quantity" value="{{quantity}}" /></td>
                                </tr>
                            {{/result}}                     
                        </tbody>
                    </table>
        	...
        	<div class="span3">
        	    ...
        	    <p>
            	    <button class="btn" onclick="document.location.href='index.jsp';">Keep Shopping</button>
	            </p>
	        </div>
		</script>
    </div>
