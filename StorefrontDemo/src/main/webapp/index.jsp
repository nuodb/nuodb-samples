...
<t:page>
    <div class="row">
        ...
        <div class="span3 sidebar">
            ...
            <script id="tpl-category-nav" type="text/template">
                <ul class="nav nav-tabs nav-stacked">
                    {{#result}}
                        <li><a href="">{{name}}<span class="badge pull-right">{{numProducts}}</span></a></li>
                    {{/result}}
                </ul>
            </script>
        </div>
        ...
        <div class="span9" id="col-content">
            ...
            <div class="navbar">
                <div class="btn-group">
                    <button class="btn active">All items</button>
            ...
            <section>
                ...
                <script id="tpl-product-list" type="text/template">
                    <ul class="thumbnails thumbnails-prod">
                        {{#result}}
                            <li class="span3">
                                <a href="product.jsp?productId={{id}}" class="thumbnail">
            ...
            <div id="paginator">Loading more...</div>
        </div>
    </div>
</t:page>
