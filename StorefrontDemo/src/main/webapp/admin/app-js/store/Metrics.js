...
Ext.define('App.store.Metrics', {
    ...
    data: [
           ...
           // Service metrics
           { category0: 'transactionStats', name: 'totalCountDelta', defaultCategoryIdx: null, view: 'metrics-throughput', title: 'Service Calls per Second', unit: 'Calls/second', groupBy0: 'Service Method', category1: 'regionTransactionStats', groupBy1: 'Region' },
           { category0: 'transactionStats', name: 'avgDurationCalc', defaultCategoryIdx: null, view: 'metrics-latency', title: 'Avg. Service Processing Time', unit: 'Milliseconds/call', groupBy0: 'Service Method', category1: 'regionTransactionStats', groupBy1: 'Region', chartType: 'area' },
