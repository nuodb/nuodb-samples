...
Ext.define('App.store.Metrics', {
    ...
    data: [
           ...
           { category0: 'transactionStats', name: 'avgDurationCalc', defaultCategoryIdx: null, view: 'metrics-service', title: 'Avg. Service Processing Time', unit: 'Milliseconds/call', groupBy0: 'Service Method', category1: 'regionTransactionStats', groupBy1: 'Region', chartType: 'area' },
           ...
           // Simulator metrics
           { category0: 'workloadStats', name: 'activeWorkerCount', defaultCategoryIdx: 1, view: 'metrics-simulator', title: 'Active Simulated Users', unit: 'Users', groupBy0: 'Workload', category1: 'regionWorkloadStats', groupBy1: 'Region' },
           { category0: 'workloadStepStats', name: 'completionCountDelta', defaultCategoryIdx: 1, view: 'metrics-simulator', title: 'Simulated Steps per Second', unit: 'Steps/second', groupBy0: 'Workload Step', category1: 'regionWorkloadStepStats', groupBy1: 'Region'  }
