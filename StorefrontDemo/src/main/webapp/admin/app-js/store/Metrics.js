...
Ext.define('App.store.Metrics', {
    ...
    data: [
           ...
           // Storefront metrics
           { category: 'storefrontStats', name: 'cartItemCount', aggregate: false, view: 'metrics-storefront', title: 'Total Items in Shopping Carts', unit: 'Items' },
           { category: 'storefrontStats', name: 'activeCustomerCount', aggregate: false, view: 'metrics-storefront', title: 'Active Customer Sessions (20 min expiry)', unit: 'Sessions' },
           { category: 'storefrontStats', name: 'purchaseItemCountDelta', aggregate: false, view: 'metrics-storefront', title: 'Items Purchased per Second', unit: 'Items/second' },
           { category: 'storefrontStats', name: 'productReviewCountDelta', aggregate: false, view: 'metrics-storefront', title: 'Reviews Written per Second', unit: 'Reviews/second' },
