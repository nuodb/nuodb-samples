...
Ext.define('App.store.Metrics', {
    ...
    data: [
           ...
           { category0: 'transactionStats', name: 'avgDurationCalc', defaultCategoryIdx: 0, view: 'metrics-service', title: 'Avg. Service Processing Time', unit: 'Milliseconds/call', groupBy0: 'Service Method', category1: 'regionTransactionStats', groupBy1: 'Region', chartType: 'line' },
